...
import static com.example.xrecyclerview.BaseRefreshHeader.STATE_DONE;
...
public class XRecyclerView extends RecyclerView {
    ...
    //默认false。设置loadingListener的时候自动设置为true。?????
    ...
    /**
     * 设置默认的LayoutManager。
     * 默认的LayoutManager是常用的 线性、垂直的LayoutManager。如果需要特殊布局用setLayoutManager
     */
