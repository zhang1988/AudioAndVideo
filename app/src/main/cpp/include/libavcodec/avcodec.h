...
/**
 * Register a user provided queue_lock manager supporting the operations
 * specified by AVLockOp. The "mutex" argument to the function points
 * to a (void *) where the lockmgr should store/get a pointer to a user
 * allocated mutex. It is NULL upon AV_LOCK_CREATE and equal to the
 * value left by the last call for all other ops. If the queue_lock manager is
 ...
 *           implement your queue_lock manager). If cb is set to NULL the
